...
dm = DUMMIFIER(transformer = sm, settings = list(transformer = list(keep_original = T)))
...
lr = SCIKIT.LR(transformer = dm, settings = list(cross_validation = list(reset_transformer = F)))
