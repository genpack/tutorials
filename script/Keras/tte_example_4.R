# exponential distribution with one parameter (landa) + censorage
...
X_train = data[trindex, c(-1, -3, -54)] %>% scale
y_train = data[trindex, 54]
c_train = data[trindex, 3] %>% as.numeric

X_test = data[- trindex, c(-1, -3, -54)] %>% scale
y_test = data[- trindex, 54]
c_test = data[- trindex, 3]
